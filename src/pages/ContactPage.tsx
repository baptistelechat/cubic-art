...
export function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const fullSubject = `Cubic Art - ${
      subjectMapping[formData.subject] || formData.subject
    }`;
    ...
    const mailtoLink = `mailto:baptistelechat@outlook.fr?subject=${encodeURIComponent(
      fullSubject
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div>
              ...
              <p className="text-gray-600 text-sm">
                La plupart des questions courantes ont déjà une réponse dans
                notre{" "}
                <Link
                  to="/about"
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                Pour les bugs et demandes de fonctionnalités, vérifiez d'abord
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                Plus votre description est détaillée, plus nous pourrons vous
                aider efficacement.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6 h-full flex flex-col">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl shadow-lg p-6">
              ...
              <Link
                to="/about"
                className="bg-white text-blue-600 px-4 py-2 rounded-lg hover:bg-blue-50 transition-colors font-medium text-sm inline-block"
              >
                Voir la FAQ
              </Link>
            </div>
